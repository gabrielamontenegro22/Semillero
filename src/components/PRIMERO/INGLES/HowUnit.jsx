...
import HowLevel1 from "./HOW/HowLevel1";
import HowLevel2 from "./HOW/HowLevel2";
import HowLevel3 from "./HOW/HowLevel3";
...
const LEVELS = [
  { number: 1, title: "Listening", description: "Escucha una pregunta y elige la imagen correcta.", icon: "🎧", maxScore: 8 },
  { number: 2, title: "Reading", description: "Ven una imagen y eligen la pregunta correcta.", icon: "👁️", maxScore: 8 },
  { number: 3, title: "Writing", description: "Escribe la palabra que falta en la oración.", icon: "✏️", maxScore: 8 },
];

export default function HowUnit() {
  ...
  const handleSaveAndFinish = async (finalScores) => {
    ...
    try {
      ...
      await guardarResultadoUnidad({ unidad: "how-many-much", periodo: 2, area: "ingles", niveles, totalScore, maxTotal });
    } catch (e) {
  ...
  if (phase === "intro") return (
    <div className="gu-screen">
      ...
      <div className="gu-card">
        ...
        <h1 className="gu-unit-title">How many? / How much?</h1>
        <p className="gu-unit-desc">Aprende cuándo usar How many y How much con la ayuda de Stitch.</p>
  ...
  if (phase === "level") return (
    <div className="gu-level-wrapper">
      ...
      {currentLevel === 0 && <HowLevel1 onFinish={handleLevelFinish} />}
      {currentLevel === 1 && <HowLevel2 onFinish={handleLevelFinish} />}
      {currentLevel === 2 && <HowLevel3 onFinish={handleLevelFinish} />}
    </div>
  );
  ...
  if (phase === "summary") return (
    <div className="gu-screen">
      ...
      <div className="gu-card gu-summary-card">
        ...
        <div className="gu-unit-badge">How many? / How much? · Completo</div>
