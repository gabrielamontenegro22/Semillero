...
import NumbersLevel1 from "./NUMBERS2/Numberslevel1";
import NumbersLevel2 from "./NUMBERS2/Numberslevel2";
import NumbersLevel3 from "./NUMBERS2/Numberslevel3";
...
const LEVELS = [
    { number: 1, title: "Listening", description: "Escucha el número y elige el correcto del 0 al 20.", icon: "🎧", maxScore: 8 },
    { number: 2, title: "Reading", description: "Lee el número y elige la palabra correcta en inglés.", icon: "👁️", maxScore: 8 },
    { number: 3, title: "Writing", description: "Escucha y escribe el nombre del número en inglés.", icon: "✏️", maxScore: 8 },
];

export default function Numbers20Unit() {
    ...
    const handleSaveAndFinish = async (finalScores) => {
        ...
        try {
            ...
            await guardarResultadoUnidad({ unidad: "numbers-0-20", periodo: 3, area: "ingles", niveles, totalScore, maxTotal });
        } catch (e) {
    ...
    if (phase === "intro") return (
        <div className="gu-screen">
            ...
            <div className="gu-card">
                ...
                <h1 className="gu-unit-title">Numbers 0-20</h1>
                <p className="gu-unit-desc">Aprende los números del cero al veinte en inglés.</p>
    ...
    if (phase === "level") return (
        <div className="gu-level-wrapper">
            ...
            {currentLevel === 0 && <NumbersLevel1 onFinish={handleLevelFinish} />}
            {currentLevel === 1 && <NumbersLevel2 onFinish={handleLevelFinish} />}
            {currentLevel === 2 && <NumbersLevel3 onFinish={handleLevelFinish} />}
        </div>
    );
    ...
    if (phase === "summary") return (
        <div className="gu-screen">
            ...
            <div className="gu-card gu-summary-card">
                ...
                <div className="gu-unit-badge">Numbers 0-20 · Completo</div>
