...
function FloatingPoints({ points, id }) {
    return <div key={id} className={`hl2-floating-points ${points > 0 ? "pos" : "neg"}`}>
...
const HouseBg = memo(function HouseBg({ color }) {
    return (
        <svg className="hl2-bg-svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
            <defs>
                <linearGradient id="hl2Wall" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#FEFCE8" />
                    <stop offset="50%" stopColor="#FEF9C3" />
                    <stop offset="100%" stopColor="#FEF3C7" />
                </linearGradient>
                <radialGradient id="hl2Glow" cx="50%" cy="50%" r="60%">
                    <stop offset="0%" stopColor={color} stopOpacity="0.15" />
                    <stop offset="100%" stopColor={color} stopOpacity="0" />
                </radialGradient>
                <linearGradient id="hl2Floor" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#92400E" />
                    <stop offset="100%" stopColor="#451A03" />
                </linearGradient>
                <linearGradient id="hl2WindowSky" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#7DD3FC" />
                    <stop offset="60%" stopColor="#BAE6FD" />
                    <stop offset="100%" stopColor="#86EFAC" />
                </linearGradient>
                <linearGradient id="hl2Curtain" x1="0" y1="0" x2="1" y2="0">
                    <stop offset="0%" stopColor="#F472B6" />
                    <stop offset="50%" stopColor="#EC4899" />
                    <stop offset="100%" stopColor="#DB2777" />
                </linearGradient>
                <linearGradient id="hl2Sofa" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#A78BFA" />
                    <stop offset="100%" stopColor="#7C3AED" />
                </linearGradient>
                <linearGradient id="hl2Rug" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#DC2626" />
                    <stop offset="50%" stopColor="#F472B6" />
                    <stop offset="100%" stopColor="#A78BFA" />
                </linearGradient>
                <linearGradient id="hl2Pot" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#F97316" />
                    <stop offset="100%" stopColor="#9A3412" />
                </linearGradient>
                <radialGradient id="hl2Lamp" cx="50%" cy="50%" r="50%">
                    <stop offset="0%" stopColor="#FEF9C3" />
                    <stop offset="80%" stopColor="#FCD34D" />
                    <stop offset="100%" stopColor="#F59E0B" />
                </radialGradient>
                <radialGradient id="hl2Vignette" cx="50%" cy="50%" r="75%">
                    <stop offset="60%" stopColor="#000" stopOpacity="0" />
                    <stop offset="100%" stopColor="#451A03" stopOpacity="0.25" />
                </radialGradient>
                <pattern id="hl2Wallpaper" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                    <path d="M40,30 C30,20 18,28 22,38 C26,48 40,55 40,55 C40,55 54,48 58,38 C62,28 50,20 40,30 Z"
                        fill="#F472B6" opacity="0.10" />
                </pattern>
            </defs>

            <rect width="1440" height="650" fill="url(#hl2Wall)" />
            <rect width="1440" height="650" fill="url(#hl2Wallpaper)" />
            <rect width="1440" height="900" fill="url(#hl2Glow)" />
            ...
            {/* Piso */}
            <rect y="650" width="1440" height="250" fill="url(#hl2Floor)" />
            ...
            <g>
                ...
                <rect x="92" y="112" width="256" height="196" fill="url(#hl2WindowSky)" />
                ...
                <path d="M 60,90 Q 70,180 65,320 L 95,320 Q 92,180 95,90 Z" fill="url(#hl2Curtain)" opacity="0.95" />
                <path d="M 380,90 Q 370,180 375,320 L 345,320 Q 348,180 345,90 Z" fill="url(#hl2Curtain)" opacity="0.95" />
                <rect x="50" y="80" width="340" height="10" fill="#451A03" rx="4" />
                <circle cx="55" cy="85" r="8" fill="#FCD34D" />
                <circle cx="385" cy="85" r="8" fill="#FCD34D" />
                <rect x="180" y="325" width="80" height="35" fill="url(#hl2Pot)" rx="4" />
            ...
            <g>
                ...
                <ellipse cx="720" cy="120" rx="50" ry="35" fill="url(#hl2Lamp)" />
            ...
            <g>
                ...
                <rect x="85" y="490" width="40" height="50" fill="url(#hl2Pot)" rx="2" />
            ...
            <g>
                ...
                <rect x="580" y="660" width="280" height="80" fill="url(#hl2Sofa)" rx="12" />
                <rect x="580" y="635" width="280" height="50" fill="url(#hl2Sofa)" rx="12" />
            ...
            {/* Alfombra */}
            <g>
                <ellipse cx="720" cy="800" rx="340" ry="22" fill="url(#hl2Rug)" />
            ...
            {/* Planta grande */}
            <g>
                <path d="M 1280,750 L 1290,800 L 1370,800 L 1380,750 Z" fill="url(#hl2Pot)" stroke="#7C2D12" strokeWidth="2" />
            ...
            {SPARKLES.map((s, i) => (
                <circle key={`sp${i}`}
                    ...
                    style={{ animation: `hl2-sparkle ${s.dur} ${s.delay} ease-in-out infinite alternate` }} />
            ))}

            <rect width="1440" height="900" fill="url(#hl2Vignette)" />
        </svg>
    );
});

export default function HouseLevel2({ onFinish }) {
    ...
    // Generar 4 opciones para cada ronda (una vez)
    ...
    const handleSelect = useCallback((selectedPart) => {
        ...
        if (isCorrect) {
            ...
            // ⭐ AUDIO REFUERZO al acertar (suena el nombre de la parte)
            const tAudio = setTimeout(() => {
                if (mountedRef.current) playWordAudio();
            }, 400);
            ...
            if (newLives <= 0) {
                ...
                // Audio del correcto al perder vidas
                const tAudio = setTimeout(() => {
                    if (mountedRef.current) playWordAudio();
                }, 500);
                timeoutRef.current.push(tAudio);
    ...
    }, [solved, finished, currentPart, errorsThisRound, streak, bestStreak, lives, current, triggerNext, playWordAudio]);
    ...
    if (!audioReady) return (
        <div className="hl2-game-root">
            <HouseBg color="#FBBF24" />
            <div className="hl2-loading">Cargando... 🏠</div>
        </div>
    );

    if (finished) return (
        <div className="hl2-game-root hl2-result-container">
            <HouseBg color="#FBBF24" />
            {floatingPoints.map(({ pts, id }) => <FloatingPoints key={id} points={pts} id={id} />)}
            <div className="hl2-result-card">
                <div className="hl2-result-emoji">🏆</div>
                <div className="hl2-result-badge">🏠 House · Level 2 👁️</div>
                <h2 className="hl2-result-title">¡Sabes leer las partes!</h2>
                <div className="hl2-result-stars">
                    {Array.from({ length: 3 }).map((_, i) => (
                        <span key={i} className={`hl2-rstar ${i < unitStars ? "lit" : "dim"}`}>⭐</span>
                    ))}
                </div>
                <div className="hl2-result-stats">
                    <div className="hl2-rstat"><span>✅</span><span>Correct</span><strong>{score}/{questions.length}</strong></div>
                    <div className="hl2-rstat"><span>⚡</span><span>Points</span><strong>{totalPoints}</strong></div>
                    <div className="hl2-rstat"><span>🔥</span><span>Best streak</span><strong>{bestStreak}x</strong></div>
                    <div className="hl2-rstat"><span>🎯</span><span>Attempts</span><strong>{attempts}</strong></div>
                    <div className="hl2-rstat"><span>⏱</span><span>Time</span><strong>{timeElapsed}s</strong></div>
                </div>
                {onFinish && (
                    <button className="hl2-result-btn" onClick={() => onFinish(score)}>
                        Finalizar 🎉
                    </button>
                )}
            </div>
    ...
    return (
        <div className="hl2-game-root">
            ...
            <div className="hl2-header-bar">
                <div className="hl2-header-left">
                    <span className="hl2-header-badge">Level 2</span>
                    <span className="hl2-header-title">👁️ Reading</span>
                </div>
                <div className="hl2-header-right">
                    <div className="hl2-header-pill">⚡ {totalPoints}</div>
                    {streak >= 2 && <div className="hl2-header-pill hl2-streak-pill">🔥 {streak}x</div>}
                    <div className="hl2-header-pill">🎯 {attempts}</div>
                    <div className="hl2-header-pill">⏱ {timeElapsed}s</div>
                </div>
            </div>

            <div className="hl2-read-container">
                <div className={`hl2-wrapper ${shake ? "hl2-shake" : ""} ${bounce ? "hl2-bounce" : ""}`}>

                    <div className="hl2-progress-track">
                        <div className="hl2-progress-fill"
                            style={{
                                width: `${progress}%`,
                                background: `linear-gradient(90deg,${roundColor},#FCD34D)`,
                                boxShadow: `0 0 12px ${roundGlow}`
                            }} />
                        <div className="hl2-progress-steps">
                            {questions.map((_, i) => (
                                <div key={i} className={`hl2-progress-dot ${i < current ? "done" : i === current ? "active" : ""}`}
                                    style={i === current ? { background: roundColor, boxShadow: `0 0 8px ${roundColor}` } : {}} />
                            ))}
                        </div>
                    </div>

                    <p className="hl2-instruction">👁️ Look and tap the correct word!</p>

                    {/* Vidas */}
                    <div className="hl2-lives-container">
                        {Array.from({ length: MAX_LIVES }).map((_, i) => (
                            <span key={i} className={`hl2-heart ${i < lives ? "alive" : "lost"}`}>
                                {i < lives ? "❤️" : "🖤"}
                            </span>
                        ))}
                    </div>

                    {/* Imagen GRANDE de la parte */}
                    <div className="hl2-image-card"
                        style={{
                            "--card-color": roundColor,
                            "--card-glow": roundGlow
                        }}>
                        <img src={currentPart.image} alt={currentPart.display} className="hl2-image" />
                    </div>

                    {/* Banner slot reservado */}
                    <div className="hl2-banner-slot">
                        {showRetryBanner && (
                            <div className="hl2-retry-banner">❌ ¡Casi! 👁️ Intenta otra vez</div>
                        )}
                        {revealCorrect && (
                            <div className="hl2-retry-banner found">
                    ...
                    {/* 4 pills de palabras */}
                    <div className="hl2-options-grid">
                        {currentOptions.map((opt) => {
                            ...
                            return (
                                <button
                                    key={opt.word}
                                    className={`hl2-option ${isCorrect ? "correct" : ""} ${isWrong ? "wrong" : ""} ${isReveal ? "reveal-correct" : ""}`}
