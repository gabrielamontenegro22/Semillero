...
const PARTS = [
    { word: "bedroom", image: bedroomImg, audio: bedroomAudio, color: "#A78BFA", glow: "rgba(167,139,250,0.7)" },
    { word: "kitchen", image: kitchenImg, audio: kitchenAudio, color: "#FB923C", glow: "rgba(251,146,60,0.7)" },
    { word: "bathroom", image: bathroomImg, audio: bathroomAudio, color: "#38BDF8", glow: "rgba(56,189,248,0.7)" },
    { word: "garage", image: garageImg, audio: garageAudio, color: "#64748B", glow: "rgba(100,116,139,0.7)" },
    { word: "garden", image: gardenImg, audio: gardenAudio, color: "#10B981", glow: "rgba(16,185,129,0.7)" },
    { word: "stairs", image: stairsImg, audio: stairsAudio, color: "#B45309", glow: "rgba(180,83,9,0.7)" },
    // ⭐ living room: niño escribe "living", "room" siempre visible como pista
    { word: "living", bonusWord: "room", image: livingroomImg, audio: livingroomAudio, color: "#FF6B9D", glow: "rgba(255,107,157,0.7)" },
    // ⭐ dining room: niño escribe "dining", "room" siempre visible como pista
    { word: "dining", bonusWord: "room", image: diningroomImg, audio: diningroomAudio, color: "#FCD34D", glow: "rgba(252,211,77,0.7)" },
];
...
function FloatingPoints({ points, id }) {
    return <div key={id} className={`hl3-floating-points ${points > 0 ? "pos" : "neg"}`}>
...
const HouseBg = memo(function HouseBg({ color }) {
    return (
        <svg className="hl3-bg-svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
            <defs>
                <linearGradient id="hl3Wall" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#FEFCE8" />
                    <stop offset="50%" stopColor="#FEF9C3" />
                    <stop offset="100%" stopColor="#FEF3C7" />
                </linearGradient>
                <radialGradient id="hl3Glow" cx="50%" cy="50%" r="60%">
                    <stop offset="0%" stopColor={color} stopOpacity="0.15" />
                    <stop offset="100%" stopColor={color} stopOpacity="0" />
                </radialGradient>
                <linearGradient id="hl3Floor" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#92400E" />
                    <stop offset="100%" stopColor="#451A03" />
                </linearGradient>
                <linearGradient id="hl3WindowSky" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#7DD3FC" />
                    <stop offset="60%" stopColor="#BAE6FD" />
                    <stop offset="100%" stopColor="#86EFAC" />
                </linearGradient>
                <linearGradient id="hl3Curtain" x1="0" y1="0" x2="1" y2="0">
                    <stop offset="0%" stopColor="#F472B6" />
                    <stop offset="50%" stopColor="#EC4899" />
                    <stop offset="100%" stopColor="#DB2777" />
                </linearGradient>
                <linearGradient id="hl3Sofa" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#A78BFA" />
                    <stop offset="100%" stopColor="#7C3AED" />
                </linearGradient>
                <linearGradient id="hl3Rug" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#DC2626" />
                    <stop offset="50%" stopColor="#F472B6" />
                    <stop offset="100%" stopColor="#A78BFA" />
                </linearGradient>
                <linearGradient id="hl3Pot" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#F97316" />
                    <stop offset="100%" stopColor="#9A3412" />
                </linearGradient>
                <radialGradient id="hl3Lamp" cx="50%" cy="50%" r="50%">
                    <stop offset="0%" stopColor="#FEF9C3" />
                    <stop offset="80%" stopColor="#FCD34D" />
                    <stop offset="100%" stopColor="#F59E0B" />
                </radialGradient>
                <radialGradient id="hl3Vignette" cx="50%" cy="50%" r="75%">
                    <stop offset="60%" stopColor="#000" stopOpacity="0" />
                    <stop offset="100%" stopColor="#451A03" stopOpacity="0.25" />
                </radialGradient>
                <pattern id="hl3Wallpaper" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                    <path d="M40,30 C30,20 18,28 22,38 C26,48 40,55 40,55 C40,55 54,48 58,38 C62,28 50,20 40,30 Z"
                        fill="#F472B6" opacity="0.10" />
                </pattern>
            </defs>

            <rect width="1440" height="650" fill="url(#hl3Wall)" />
            <rect width="1440" height="650" fill="url(#hl3Wallpaper)" />
            <rect width="1440" height="900" fill="url(#hl3Glow)" />

            <rect x="0" y="630" width="1440" height="20" fill="#92400E" />
            <rect x="0" y="650" width="1440" height="6" fill="#451A03" />

            <rect y="650" width="1440" height="250" fill="url(#hl3Floor)" />
            {Array.from({ length: 8 }, (_, i) => (
                <line key={`fl${i}`} x1={i * 180} y1="650" x2={i * 180} y2="900"
                    stroke="#451A03" strokeWidth="2" opacity="0.6" />
            ))}
            {Array.from({ length: 7 }, (_, i) => (
                <line key={`fh${i}`} x1="0" y1={680 + i * 30} x2="1440" y2={680 + i * 30}
            ...
            <g>
                ...
                <rect x="92" y="112" width="256" height="196" fill="url(#hl3WindowSky)" />
                ...
                <path d="M 60,90 Q 70,180 65,320 L 95,320 Q 92,180 95,90 Z" fill="url(#hl3Curtain)" opacity="0.95" />
                <path d="M 380,90 Q 370,180 375,320 L 345,320 Q 348,180 345,90 Z" fill="url(#hl3Curtain)" opacity="0.95" />
                <rect x="50" y="80" width="340" height="10" fill="#451A03" rx="4" />
                <circle cx="55" cy="85" r="8" fill="#FCD34D" />
                <circle cx="385" cy="85" r="8" fill="#FCD34D" />
                <rect x="180" y="325" width="80" height="35" fill="url(#hl3Pot)" rx="4" />
            ...
            <g>
                ...
                <ellipse cx="720" cy="120" rx="50" ry="35" fill="url(#hl3Lamp)" />
            ...
            <g>
                ...
                <rect x="85" y="490" width="40" height="50" fill="url(#hl3Pot)" rx="2" />
            ...
            <g>
                ...
                <rect x="580" y="660" width="280" height="80" fill="url(#hl3Sofa)" rx="12" />
                <rect x="580" y="635" width="280" height="50" fill="url(#hl3Sofa)" rx="12" />
            ...
            {/* Alfombra */}
            <g>
                <ellipse cx="720" cy="800" rx="340" ry="22" fill="url(#hl3Rug)" />
            ...
            {/* Planta grande */}
            <g>
                <path d="M 1280,750 L 1290,800 L 1370,800 L 1380,750 Z" fill="url(#hl3Pot)" stroke="#7C2D12" strokeWidth="2" />
            ...
            {SPARKLES.map((s, i) => (
                <circle key={`sp${i}`}
                    ...
                    style={{ animation: `hl3-sparkle ${s.dur} ${s.delay} ease-in-out infinite alternate` }} />
            ))}

            <rect width="1440" height="900" fill="url(#hl3Vignette)" />
        </svg>
    );
});

export default function HouseLevel3({ onFinish }) {
    ...
    const currentWord = currentPart.word;
    const bonusWord = currentPart.bonusWord;
    ...
    }, [solved, finished, typed, currentWord, currentPart, errorsThisRound, streak, bestStreak, lives, current, triggerNext, playAudio]);
    ...
    if (finished) return (
        <div className="hl3-game-root hl3-result-container">
            <HouseBg color="#FBBF24" />
            {floatingPoints.map(({ pts, id }) => <FloatingPoints key={id} points={pts} id={id} />)}
            <div className="hl3-result-card">
                <div className="hl3-result-emoji">🏆</div>
                <div className="hl3-result-badge">🏠 House · Level 3 ✏️</div>
                <h2 className="hl3-result-title">¡Eres un crack escribiendo!</h2>
                <div className="hl3-result-stars">
                    {Array.from({ length: 3 }).map((_, i) => (
                        <span key={i} className={`hl3-rstar ${i < unitStars ? "lit" : "dim"}`}>⭐</span>
                    ))}
                </div>
                <div className="hl3-result-stats">
                    <div className="hl3-rstat"><span>✅</span><span>Correct</span><strong>{score}/{questions.length}</strong></div>
                    <div className="hl3-rstat"><span>⚡</span><span>Points</span><strong>{totalPoints}</strong></div>
                    <div className="hl3-rstat"><span>🔥</span><span>Best streak</span><strong>{bestStreak}x</strong></div>
                    <div className="hl3-rstat"><span>🎯</span><span>Attempts</span><strong>{attempts}</strong></div>
                    <div className="hl3-rstat"><span>⏱</span><span>Time</span><strong>{timeElapsed}s</strong></div>
                </div>
                {onFinish && (
                    <button className="hl3-result-btn" onClick={() => onFinish(score)}>
                        Finalizar 🎉
                    </button>
                )}
            </div>
    ...
    return (
        <div className="hl3-game-root">
            <HouseBg color={roundColor} />
            {floatingPoints.map(({ pts, id }) => <FloatingPoints key={id} points={pts} id={id} />)}

            <div className="hl3-header-bar">
                <div className="hl3-header-left">
                    <span className="hl3-header-badge">Level 3</span>
                    <span className="hl3-header-title">✏️ Writing</span>
                </div>
                <div className="hl3-header-right">
                    <div className="hl3-header-pill">⚡ {totalPoints}</div>
                    {streak >= 2 && <div className="hl3-header-pill hl3-streak-pill">🔥 {streak}x</div>}
                    <div className="hl3-header-pill">🎯 {attempts}</div>
                    <div className="hl3-header-pill">⏱ {timeElapsed}s</div>
                </div>
            </div>

            <div className="hl3-write-container">
                <div className={`hl3-wrapper ${shake ? "hl3-shake" : ""} ${bounce ? "hl3-bounce" : ""}`}>

                    <div className="hl3-progress-track">
                        <div className="hl3-progress-fill"
                            style={{
                                width: `${progress}%`,
                                background: `linear-gradient(90deg,${roundColor},#FCD34D)`,
                                boxShadow: `0 0 12px ${roundGlow}`
                            }} />
                        <div className="hl3-progress-steps">
                            {questions.map((_, i) => (
                                <div key={i} className={`hl3-progress-dot ${i < current ? "done" : i === current ? "active" : ""}`}
                                    style={i === current ? { background: roundColor, boxShadow: `0 0 8px ${roundColor}` } : {}} />
                            ))}
                        </div>
                    </div>

                    <p className="hl3-instruction">✏️ Listen and write the part of the house!</p>

                    <div className="hl3-main-row">

                        <div className="hl3-part-mini"
                            style={{
                                "--part-color": roundColor,
                                "--part-glow": roundGlow
                            }}>
                            <img src={currentPart.image} alt="part" className="hl3-part-mini-img" />
                        </div>

                        <div className="hl3-controls-col">
                            <div className="hl3-play-row">
                                <button
                                    className={`hl3-play-btn ${isPlaying ? "playing" : ""}`}
                                    onClick={playAudio}
                                ...
                                >
                                    <span className="hl3-play-icon">{isPlaying ? "🔊" : "▶"}</span>
                                    <span className="hl3-play-text">{isPlaying ? "Listen…" : "Play"}</span>
                                </button>

                                <div className="hl3-lives-container">
                                    {Array.from({ length: MAX_LIVES }).map((_, i) => (
                                        <span key={i} className={`hl3-heart ${i < lives ? "alive" : "lost"}`}>
                                            {i < lives ? "❤️" : "🖤"}
                                        </span>
                                    ))}
                                </div>
                            ...
                            {/* Slots de letras */}
                            {bonusWord ? (
                                /* ⭐ COMPUESTA (living room / dining room): 2 líneas */
                                <div className="hl3-slots-stacked">
                                    {/* Línea 1: palabra principal */}
                                    <div className="hl3-slots">
                                        {currentWord.split("").map((letter, i) => {
                                            ...
                                            return (
                                                <div key={`main-${i}`}
                                                    className={`hl3-slot ${isFilled ? "filled" : ""} ${isHint ? "hint" : ""} ${isFail ? "fail" : ""}`}
                                                    style={isFilled ? {
                                    ...
                                    {/* Línea 2: bonusWord (room) - SIEMPRE visible amarillo */}
                                    <div className="hl3-slots">
                                        {bonusWord.split("").map((letter, i) => (
                                            <div key={`bonus-${i}`}
                                                className="hl3-slot filled hint">
                                                {letter}
                                            </div>
                                        ))}
                                    </div>
                                ...
                                /* SIMPLE (bedroom, kitchen, etc): 1 línea */
                                <div className="hl3-slots">
                                    {currentWord.split("").map((letter, i) => {
                                        const isFilled = i < typed.length;
                                        const isHint = i < hintCount;
                            ...
                            <div className="hl3-banner-slot">
                                {showRetryBanner && (
                                    <div className="hl3-retry-banner">❌ ¡Casi! ✏️ Inténtalo de nuevo</div>
                                )}
                                {revealedFails.length > 0 && (
                                    <div className="hl3-retry-banner found">
                    ...
                    <div className="hl3-keyboard">
                        {KEYBOARD_ROWS.map((row, ri) => (
                            <div key={ri} className="hl3-keyboard-row">
                                {row.map(letter => {
                                    const isWrong = wrongLetters.includes(letter);
                                    return (
                                        <button
                                            key={letter}
                                            className={`hl3-key ${isWrong ? "wrong" : ""}`}
