...
import PetsLevel1 from "./PETS/PetsLevel1";
import PetsLevel2 from "./PETS/PetsLevel2";
import PetsLevel3 from "./PETS/Petslevel3";
...
const LEVELS = [
    { number: 1, title: "Listening", description: "Escucha el nombre del animal y elige la imagen correcta.", icon: "🎧", maxScore: 8 },
    { number: 2, title: "Reading", description: "Lee la descripción del animal y elige el correcto.", icon: "👁️", maxScore: 8 },
    { number: 3, title: "Writing", description: "Escribe el nombre del animal letra por letra.", icon: "✏️", maxScore: 8 },
];

export default function PetsUnit() {
    ...
    const handleSaveAndFinish = async (finalScores) => {
        ...
        try {
            ...
            // ✅ FIX 1: periodo: 3 (Animals & Pets pertenece al Periodo 3)
            await guardarResultadoUnidad({ unidad: "animals-pets", periodo: 3, area: "ingles", niveles, totalScore, maxTotal });
        } catch (e) {
    ...
    if (phase === "intro") return (
        <div className="gu-screen">
            ...
            <div className="gu-card">
                {/* ✅ FIX 2: Badge Periodo 3 */}
                <div className="gu-unit-badge">Periodo 3 · Inglés 1°</div>
                <div className="gu-unit-emoji">🐶</div>
                <h1 className="gu-unit-title">Animals &amp; Pets</h1>
                {/* ✅ FIX 3: Descripción sin "Po" */}
                <p className="gu-unit-desc">Aprende los nombres de los animales y mascotas en inglés.</p>
    ...
    if (phase === "level") return (
        <div className="gu-level-wrapper">
            ...
            {currentLevel === 0 && <PetsLevel1 onFinish={handleLevelFinish} />}
            {currentLevel === 1 && <PetsLevel2 onFinish={handleLevelFinish} />}
            {currentLevel === 2 && <PetsLevel3 onFinish={handleLevelFinish} />}
        </div>
    );
    ...
    if (phase === "summary") return (
        <div className="gu-screen">
            ...
            <div className="gu-card gu-summary-card">
                ...
                <div className="gu-unit-badge">Animals &amp; Pets · Completo</div>
