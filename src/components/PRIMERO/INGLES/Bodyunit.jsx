...
import BodyLevel1 from "./BODY/BodyLevel1";
import BodyLevel2 from "./BODY/BodyLevel2";
import BodyLevel3 from "./BODY/BodyLevel3";
...
const AUDIOS_TO_PRELOAD = [
    headAudio, eyeAudio, earAudio, noseAudio, mouthAudio, handAudio, footAudio, legAudio, armAudio, neckAudio, correctoSound, incorrectoSound
];

const LEVELS = [
    { number: 1, title: "Listening", description: "Escucha y elige la parte del cuerpo correcta.", icon: "🎧", maxScore: 10 },
    { number: 2, title: "Reading", description: "Mira el emoji y elige la palabra correcta.", icon: "👁️", maxScore: 10 },
    { number: 3, title: "Writing", description: "Escucha y escribe el nombre de la parte del cuerpo.", icon: "✏️", maxScore: 10 },
];

export default function BodyUnit() {
    ...
    const handleSaveAndFinish = async (finalScores) => {
        ...
        try {
            ...
            await guardarResultadoUnidad({ unidad: "parts-of-the-body", periodo: 4, area: "ingles", niveles, totalScore, maxTotal });
        } catch (e) {
    ...
    if (phase === "intro") return (
        <div className="gu-screen">
            ...
            <div className="gu-card">
                ...
                <h1 className="gu-unit-title">Parts of the Body</h1>
                <p className="gu-unit-desc">Aprende las partes del cuerpo en inglés: head, eyes, nose, mouth, hands y feet.</p>
    ...
    if (phase === "level") return (
        <div className="gu-level-wrapper">
            ...
            {currentLevel === 0 && <BodyLevel1 onFinish={handleLevelFinish} />}
            {currentLevel === 1 && <BodyLevel2 onFinish={handleLevelFinish} />}
            {currentLevel === 2 && <BodyLevel3 onFinish={handleLevelFinish} />}
        </div>
    );
    ...
    if (phase === "summary") return (
        <div className="gu-screen">
            ...
            <div className="gu-card gu-summary-card">
                ...
                <div className="gu-unit-badge">Parts of the Body · Completo</div>
