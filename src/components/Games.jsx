...
function AnimatedBg() {
  return (
    <svg className="games-svg-bg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect width="1440" height="900" fill="url(#gm-sky)"/>
...
export default function Games() {
  ...
  const periodos = [
    { nombre: 'Primer Periodo',   numero: 1 },
    { nombre: 'Segundo Periodo',  numero: 2 },
    { nombre: 'Tercer Periodo',   numero: 3 },
    { nombre: 'Cuarto Periodo',   numero: 4 },
  ];
  ...
  return (
    <div className="games-container">
      ...
      <div className="letras">
        <h2>{AREA_LABELS[area] ?? '🎮 Periodos'} — Periodos</h2>
      </div>
      ...
      <div className="games-grid">
        {periodos.map((periodo, i) => (
          <div
            key={periodo.numero}
            className="game-card"
            onClick={() => navigate(`/english/periodo/${periodo.numero}`, { state: { area } })}
          >
            <span className="game-icon">{PERIODO_ICONS[i]}</span>
